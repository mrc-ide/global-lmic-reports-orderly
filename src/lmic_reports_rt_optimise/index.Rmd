...
**The following scenarios do not account for future VoC and assumes the current VoC (based on sequence data) remains dominant.**
...
suppressWarnings(suppressMessages(gg_hosp <- healthcare_plot_contrast(
  projs = combined_projections, what = "hospital_demand", date = date, forecast = 28
)))
suppressWarnings(suppressMessages(gg_icu <- healthcare_plot_contrast(
  projs = combined_projections, what = "ICU_demand", date = date, forecast = 28
)))
...
suppressWarnings(suppressMessages(healthcare_plot_contrast(
  projs = combined_projections, what = "infections", date = date, forecast = 28
)))
...
Legacy scenarios with a flat $50\%$ increase/decrease to $R_t$ are presented here.
...
suppressWarnings(suppressMessages(gg_hosp_leg <- healthcare_plot_contrast(
  projs = combined_projections_leg, what = "hospital_demand", date = date, forecast = 28
)))
suppressWarnings(suppressMessages(gg_icu_leg <- healthcare_plot_contrast(
  projs = combined_projections_leg, what = "ICU_demand", date = date, forecast = 28
)))
leg <- suppressWarnings(suppressMessages(
...
suppressWarnings(suppressMessages(healthcare_plot_contrast(
  projs = combined_projections_leg, what = "infections", date = date, forecast = 28
)))
```
