...
```{r healthcare plots, echo = FALSE, collapse=TRUE, message = FALSE, warning = FALSE, fig.cap=figRef("**Figure 5: Scenario projection for the next 28 days.** Individuals needing an ICU bed are assumed to need mechanical ventilation. **"), fig.width=fig_height(8,10), fig.height=fig_height(10,12), fig.align=fig_center()}
