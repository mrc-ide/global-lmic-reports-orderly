...
* We now present the effective reproduction number $R_{eff}$, which incorporates the impact that immunity has on transmission as well as the impact of interventions. Previously we presented the time varying reproductive number, $R_t$, which does not show the impat of immunity and only represents changes in transmission due to interventions. 
* Switching to Johns Hopkins Data source via https://github.com/CSSEGISandData/COVID-19 (2020-08-21)
