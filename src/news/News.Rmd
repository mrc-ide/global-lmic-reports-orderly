...
* We now present the effective reproduction number, which incorporates the impact that immunity has on transmission as well as the impact of interventionss. Previously we presented the time varying reproductive reproductive number without immunity, which only represented changes in transmission due to interventions. 
