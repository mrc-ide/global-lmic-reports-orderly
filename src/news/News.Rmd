...
As we move from one version to the next, we will still have the last date at which the previous version was run available to be viewed. To access a previous version, append `/vx` to the country page url, where `x` is the version number. For example, to access the version 1 page for Algeria, the full url would be: [https://mrc-ide.github.io/global-lmic-reports/DZA/v1](https://mrc-ide.github.io/global-lmic-reports/DZA/v1).

Lastly, as we switch from one version to the next, there is likely to be a small delay in keeping the sebsite up to date. We apologise for the delays.

---

#### Version 4: 2020-07-02
