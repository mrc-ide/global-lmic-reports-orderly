...
## Situation Report for COVID-19: `r cotninent`, `r format(date, "%Y-%m-%d")`
...
```{r fig1, echo = FALSE, collapse=TRUE, message = FALSE, warning = FALSE, fig.align=fig_center(),fig.width=10, fig.height=fig_height(10,10), fig.cap=figRef("Cumulative Deaths since 10 deaths. The projected deaths (assuming population mobility is maintained at today's level) are shown with dashed lines.")}
...
cumulative_deaths_plot_continent_projections(continent, 
                  today = date, 
                  data = data, 
                  ecdc = ecdc)
))
