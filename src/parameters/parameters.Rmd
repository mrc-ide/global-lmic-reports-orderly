...
Adjustments for the Delta Variant are adjusted for. This Variant of Concern has
...
For countries with more than 100 reported cases sequences, we model these effects as follows:
...
* Reduced Vaccine Efficacy: Vaccines efficacy against infection reduces to 22.4%,
...
The timing of when the Delta variant becomes dominant is estimated using data 
available from [CoVariants](https://covariants.org/). If a countries fit takes
into account the Delta Adjustments, this will be indicated on its page.
