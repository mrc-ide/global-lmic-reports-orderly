...
Adjustments have been made for both the Delta and Omicron Variants. The Delta
adjust is now applied to all countries.
For the Omicron variant, we model these effects as follows:

* Immune escape: we increase the rate of loss of natural immunity for a two 
month period such that 57.8% ([Report 49](https://www.imperial.ac.uk/mrc-global-infectious-disease-analysis/covid-19/report-49-omicron/)) of those that would not have been susceptible, now are.

* Worse Outcomes: The probability of hospitalisation increases over that period
so that it is 59% of that for the delta variant ([Report 50](https://www.imperial.ac.uk/mrc-global-infectious-disease-analysis/covid-19/report-50-severity-omicron/)) and risk severe disease 34% of what is was for the Delta variant..

* Reduced Vaccine Efficacy: Vaccine efficacy against infection reduces to 0%,
first dose, and 10%, second dose. Efficacy against disease reduces to 42%, first dose,
and 53%, second dose. These are roughly taken from [Report 49](https://www.imperial.ac.uk/mrc-global-infectious-disease-analysis/covid-19/report-49-omicron/) and [Report 50](https://www.imperial.ac.uk/mrc-global-infectious-disease-analysis/covid-19/report-50-severity-omicron/) and consistent with [UHSA COVID-19 Vaccine Surveillance Report Week 4](https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/1050721/Vaccine-surveillance-report-week-4.pdf).

When the Delta variant becomes dominant is estimated using data 
available from [CoVariants](https://covariants.org/). Countries that take
into account the Delta variant will be indicated on its specific page.


### Version 9

Adjustments have been made for the Delta Variant. This Variant of Concern has
become the dominant strain of COVID-19 for many countries across the globe, see
[WHO weekly update](https://www.who.int/publications/m/item/weekly-epidemiological-update-on-covid-19---2-november-2021). The Delta Variant has been associated with immune escape from natural 
immunity for previous variants, worse clinical outcomes, and reduced vaccine efficacy.

For countries with more than 100 reported Delta sequences, we model these effects as follows:

* Immune escape: we increase the rate of loss of natural immunity for a two 
month period such that 27% ([Genomic characterization and epidemiology of an emerging SARS-CoV-2 variant in Delhi, India](https://www.science.org/doi/10.1126/science.abj9932)) of those that would not have been susceptible, now are.

* Worse Outcomes: The probability of hospitalisation increases over that period
so that it is 45% higher than for the non-delta variants ([Hospital admission and emergency care attendance risk for SARS-CoV-2 delta (B.1.617.2) compared with alpha (B.1.1.7) variants of concern: a cohort study](https://www.thelancet.com/journals/laninf/article/PIIS1473-3099(21)00475-8/fulltext)).

* Reduced Vaccine Efficacy: Vaccine efficacy against infection reduces to 22.4%,
first dose, and 64.6%, second dose. Efficacy against disease reduces to 75%, first dose,
and 94%, second dose. These are roughly taken from [here](https://www.eurosurveillance.org/content/10.2807/1560-7917.ES.2021.26.35.2100793)
and [round 14](http://hdl.handle.net/10044/1/91999) of the REACT study.
