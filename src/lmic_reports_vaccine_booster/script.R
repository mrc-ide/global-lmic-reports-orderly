...
if(sum(ecdc_df$deaths) > 0) {
  ...
  out <- drjacoby_mcmc(data = data,
                       ...
                       date_vaccine_efficacy_infection_change = vacc_inputs$date_vaccine_efficacy_change,
                       vaccine_efficacy_infection = vacc_inputs$vaccine_efficacy_infection[-1],
                       baseline_vaccine_efficacy_infection = vacc_inputs$vaccine_efficacy_infection[[1]],
                       date_vaccine_efficacy_disease_change = vacc_inputs$date_vaccine_efficacy_change,
                       vaccine_efficacy_disease = vacc_inputs$vaccine_efficacy_disease[-1],
  ...
  if(document){
    ...
    saveRDS(NULL, "input_params.json")
  }
