...
#### 4. What have you assumed about comorbidities?
...
#### 5. Why are most of the model parameters based on UK data?
...
#### 6. Can heterogeneity reduce the spread of the infection and so result in lower final attack rates?
...
#### 7. Do your projections change if you modelled subnationally?
...
#### 8. Why do your models only consider direct COVID-19 deaths? / How do your predictions account for excess mortality?
...
Our outputs should therefore be considered as inputs into wider discussion about the appropriate balance between mitigation/suppression of SARS-CoV-2 virus transmission and the impact of these interventions on wider health.
