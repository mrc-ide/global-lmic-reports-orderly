...
We use two sources of data to calibrate the model. The first is the reported numbers of deaths by date as available in the European Centre for Disease Control database and in more recent version from the Johns Hopkins University database. These data are updated daily and whilst there may be a short delay, they are generally consistent with Ministry reports. However, as noted below, it is not clear what proportion of deaths are reported.
