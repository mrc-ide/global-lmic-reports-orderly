...
suppressMessages(cases_plot(params$o_list[[1]], data = data, date = date, date_0 = date_0))
...
* Scenario 1. The epidemic continues to grow exponentially at the current rate. 
* Scenario 2. Countries will scale up interventions leading to a 50% reduction in transmission.
