...
Either execute this from the terminal or you can run it using the bash code chunk below (though it doesn't produce output u at the moment, which may be annoying so you can see the output). 
```{bash}
