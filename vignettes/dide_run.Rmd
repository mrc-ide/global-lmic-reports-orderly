...
iso3cs_to_rerun_2 <- c("PRY", "SGP", "SVK", "HKG") 
bundles_to_rerun_2 <- lapply(
  iso3cs_to_rerun_2, 
  function(x) {
    orderly::orderly_bundle_pack(
      path = path_bundles,
...
names(bundles_to_rerun_2) <- iso3cs_to_rerun_2
saveRDS(bundles_to_rerun_2, file.path(path_bundles, "bundles_to_rerun_2.rds"))
