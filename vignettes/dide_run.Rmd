...
economist_id <- orderly::orderly_run("economist", parameters = list(date=date), echo = FALSE)
orderly::orderly_commit(economist_id)
...
qpdf::pdf_combine(
  ...
  output = file.path("fits", paste0("lmic_reports_vaccine_rerun_", date, ".pdf"))
)
```
