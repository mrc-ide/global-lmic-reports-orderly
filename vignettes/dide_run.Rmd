...
#requires git bash be on the path and that the working directory is set correctly
log <- shell("scripts/update_github_pages.sh", intern = TRUE, wait = TRUE, shell = "bash")
```
...
#requires git bash be on the path and that the working directory is set correctly
#shell(paste0("scripts/update_github_esft.sh", " ", date), intern = TRUE, wait = TRUE, shell = "bash")
dput(paste0("scripts/update_github_esft.sh", " ", date))
```
