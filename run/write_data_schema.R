...
write_data_schema <- function() {
  ...
  lines <- c(
    ...
    "* **scenario** - The intervention scenario explored. One of Maintain Status Quo, Optimistic, Pessimistic. Surged Maintain Status Quo also present in countries estimated to pass capacity in next 28 days.",
