...
parallel --progress -j 32 ./orderly run lmic_reports_google_pmcmc_spline_np iso3c={} date=$DATE short_run=$SHORT_RUN parallel=$PARALLEL full_scenarios=$FULL_SCENARIOS
