...
parallel --progress -j 21  ./orderly run lmic_reports_google_pmcmc_no_decouple iso3c={} date=$DATE short_run=$SHORT_RUN parallel=$PARALLEL full_scenarios=$FULL_SCENARIOS
